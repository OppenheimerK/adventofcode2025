package body Dial is
   ...
   procedure Next (Steps : Integer; Current_Position : out Node_Access) is
   begin
   ...
   procedure Previous (Steps : Integer; Current_Position : out Node_Access) is
   begin
      for I in 1 .. Steps loop
